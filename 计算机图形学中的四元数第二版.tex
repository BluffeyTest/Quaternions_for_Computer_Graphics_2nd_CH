...
\newtcbtheorem[number within=chapter]{myexample}{例}%
  {breakable, enhanced, colback=green!5,colframe=green!35!black,fonttitle=\bfseries}{th}
%   {colback=green!5,colframe=green!35!black,fonttitle=\bfseries}{th}


%% 我自己尝试搞定理环境
\newtheorem{example}{\textcolor{blue}{\indent 例}}[chapter]
% \renewcommand{\theexample}{\textcolor{main}{\arabic{example}}}
% \renewcommand{\theexample}{\textcolor{red}{\thesection.\arabic{example}}}
...
\newenvironment{Li}[1][\introductionname]{
  \begin{tcolorbox}[colback=white!5!white,colframe=green!75!white]
  \begin{example}
  \bfseries
    %\textbf{#1}
...
\include{Triples_and_Quaternions}
